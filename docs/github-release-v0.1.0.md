...
- 2026-06-02: CheapAgent is the working brand for the hosted app follow-through; `cheapagent.ai` is registered, but public-launch language should wait until the Netlify custom-domain SSL gate is complete.
