...
- Historical 2026-06-02 note: CheapAgent was the working brand for the hosted app follow-through, and `cheapagent.ai` had been registered while Netlify SSL was still pending. Current docs supersede this: `https://cheapagent.ai/` now serves the controlled alpha, with `www.cheapagent.ai` redirecting to apex.
